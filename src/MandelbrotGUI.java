...
public class MandelbrotGUI {
    ...
    private static final double DEFAULT_MAX_REAL = 5;
     ...
     *
     * @param image       A matrix of color objects, each of whose elements is
     *                    interpreted as a picture element of the image to draw.
     * @param pixelWidth  The <b>width</b> of a picture element.
     * @param pixelHeight The <b>height</b> of a picture element.
     */
    ...
    class FGFrame extends JFrame implements ActionListener {
         ...
         *
         * @param enabled True/false for enable/disable.
         */
        ...
        class ComplexPlane extends JPanel implements MouseListener,
             ...
             *
             * @param color The color matrix
             * @param pw    The "pixel width"
             * @param ph    The "pixel height"
             */
